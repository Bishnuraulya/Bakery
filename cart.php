<?php
    session_start();
        $con=mysqli_connect("localhost" , "root", "", "bakery_db")or die("can not connect");
    // if(!isset($_SESSION['email'])){
        // header('location: login.php');
    // }
    // $user_id=$_SESSION['id'];
    // $user_products_query="select * from   products order by ID ASC";
	//where ID='$user_id'";
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                         ...
                         ?>
                        <tr>
                            <th><?php echo $counter ?></th><th><?php echo $row['Name']?>
							</th><th><?php echo $row['Price']?></th>
