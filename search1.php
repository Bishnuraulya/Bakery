...
<head>
   ...
   <form action="search1.php" method="post">
    ...
    <input type ="text" name="name" placeholder="Search From Here!">
      <input type ="hidden" name="phone" placeholder="Enter Here your Phone">
    <input type="submit" style="margin-top:5px" name="search" class="btn btn-success"  /><span class = "glyphicon glyphicon-send"></span>
	</center>
    </form>
